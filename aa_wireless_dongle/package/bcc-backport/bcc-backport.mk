...
BCC_BACKPORT_VERSION = 0.29.1
BCC_BACKPORT_SITE = https://github.com/iovisor/bcc/releases/download/v$(BCC_BACKPORT_VERSION)
BCC_BACKPORT_SOURCE = bcc-src-with-submodule.tar.gz
BCC_BACKPORT_LICENSE = Apache-2.0
BCC_BACKPORT_LICENSE_FILES = LICENSE.txt
BCC_BACKPORT_INSTALL_STAGING = YES
BCC_BACKPORT_DEPENDENCIES = \
	clang \
	elfutils \
	flex \
	host-bison \
...
BCC_BACKPORT_CONF_OPTS = \
	-DENABLE_LLVM_SHARED:BOOL=ON \
	-DREVISION:STRING=$(BCC_BACKPORT_VERSION) \
	-DENABLE_CLANG_JIT:BOOL=ON \
	-DENABLE_MAN:BOOL=OFF \
	-DENABLE_EXAMPLES:BOOL=OFF \
	-DPY_SKIP_DEB_LAYOUT:BOOL=ON

define BCC_BACKPORT_LINUX_CONFIG_FIXUPS
